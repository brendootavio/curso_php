...
class UserModel extends Model
{
    ...
    public function all(int $limit = 30, int $offset = 0, string $columns = "*"): ?array
    {
        ...
        if ($this->fail() || !$all->rowCount()) {
            $this->message = "Sua consulta não retornou Usúarios!";
            return null;
        }
    ...
    public function destroy(): ?UserModel
    {
        ...
        $this->message = "Usúario removido com sucesso";
        $this->data = null;
    ...
    private function required() : bool
    {
     if(empty($this->first_name) || empty($this->last_name) || empty($this->email)){
        $this->message = "Nome, email e e-mail são obrigatótios";
        return false;
     }

     if(!filter_var($this->email, FILTER_VALIDATE_EMAIL)){
         $this->message = "E-mail informado não é um email válido";
         return false;
     }
